#AIzaSyA97xc3LpVqsLbS8RQZRUkVtxjMKRSLzLg
import sys
import importlib.util

print("현재 실행 파이썬:", sys.executable)
print("google 위치:", importlib.util.find_spec("google"))
print("google.genai 위치:", importlib.util.find_spec("google.genai"))
...
def main():
    api_key = os.environ.get("GEMINI_API_KEY", "AIzaSyCw9_Jpa_0hyy3fD8ak1zeeKzoxzRw9fxA")
    if not api_key:
