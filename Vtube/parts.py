...
# ── 설정 ─────────────────────────────────────────────────
TEXTURE_PATH = r"C:\Program Files (x86)\Steam\steamapps\common\VTube Studio\VTube Studio_Data\StreamingAssets\Live2DModels\akari_vts_ai_test\akari.4096\texture_00.png"     # 원본 텍스처
OUTPUT_DIR   = r"C:\Users\82106\OneDrive\바탕 화면\Vtube"         # 잘라낸 파츠 저장 폴더
